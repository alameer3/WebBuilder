                          ...
                          <div className="col-lg-3 col-md-6 col-12 col-12 offset-lg-6 offset-md-6">
                            <div className="form-group mb-12 mb-lg-0">
                              <select className="form-control" name="category">
                                ...
                                <option value="84">جريمة</option>
                                <option value="80">حواري</option>
                                <option value="85">دراما</option>
                                <option value="79">فني</option>
                                <option value="78">ديني</option>
                                <option value="77">كاميرا خفية</option>
                                <option value="76">سيرة ذاتية</option>
                                <option value="75">تاريخي</option>
                                <option value="73">مسابقات</option>
                              </select>
                            </div>
                          </div>
                  ...
                  <div key={index} className="col-lg-2 col-md-4 col-6 mb-12">
                    <div className="entry-box entry-box-1">
                      <div className="labels d-flex">
                        ...
                        <span className="label quality">WEB-DL</span>
                      </div>
                      <div className="entry-image">
                        <a href={`/show/${index + 1}`} className="box">
                          <picture>
                            <img 
                      ...
                      <div className="entry-body px-3 pb-3 text-center">
                        <div className="actions d-flex justify-content-center">
                          <a href={`/show/${index + 1}`} className="icn play">
                        ...
                        <h3 className="entry-title font-size-14 m-0">
                          <a href={`/show/${index + 1}`} className="text-white">
                            برنامج تلفزيوني {index + 1}
                          </a>
                        </h3>
