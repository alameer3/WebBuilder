...
export default function Recent() {
  const { data: recentMovies, isLoading } = useQuery<Movie[]>({
  ...
  if (isLoading) {
    return (
      <div className="container mx-auto">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-white mb-2">الأحدث</h1>
          <p className="text-gray-400">أحدث الأفلام والمسلسلات المضافة</p>
        </div>
    ...
    <div className="container mx-auto">
      ...
      <div className="mb-8">
        <div className="flex items-center gap-3 mb-4">
          ...
          <h1 className="text-3xl font-bold text-white">الأحدث</h1>
        </div>
        <p className="text-gray-400">أحدث الأفلام والمسلسلات المضافة حديثاً لمكتبتنا</p>
      </div>
            ...
            <CardContent className="p-0">
              <div className="relative">
                ...
                <div className="absolute bottom-2 left-2 bg-black/70 text-white px-2 py-1 rounded text-xs">
                  {item.addedDate ? new Date(item.addedDate).toLocaleDateString('ar-YE') : 'حديث'}
                </div>
